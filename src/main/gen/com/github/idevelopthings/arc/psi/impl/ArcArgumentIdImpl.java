...
public class ArcArgumentIdImpl extends ArcNamedElementImpl implements ArcArgumentId {

  public ArcArgumentIdImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ArcVisitor visitor) {
    visitor.visitArgumentId(this);
  }
