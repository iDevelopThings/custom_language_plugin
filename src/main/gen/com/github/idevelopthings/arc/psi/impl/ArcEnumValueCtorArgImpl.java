...
public class ArcEnumValueCtorArgImpl extends ArcElementImpl implements ArcEnumValueCtorArg {

  public ArcEnumValueCtorArgImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ArcVisitor visitor) {
    visitor.visitEnumValueCtorArg(this);
  }
