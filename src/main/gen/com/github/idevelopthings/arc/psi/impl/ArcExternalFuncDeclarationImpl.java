...
public class ArcExternalFuncDeclarationImpl extends ArcFunctionImpl implements ArcExternalFuncDeclaration {

  public ArcExternalFuncDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public PsiElement getExternKw() {
    return findNotNullChildByType(EXTERN_KW);
  }
