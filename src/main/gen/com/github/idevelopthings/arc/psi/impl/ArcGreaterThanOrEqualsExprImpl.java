...
public class ArcGreaterThanOrEqualsExprImpl extends ArcExpressionImpl implements ArcGreaterThanOrEqualsExpr {

  public ArcGreaterThanOrEqualsExprImpl(@NotNull ASTNode node) {
    super(node);
  }
