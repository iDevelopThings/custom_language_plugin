...
public class ArcHttpBlockImpl extends ArcElementImpl implements ArcHttpBlock {

  public ArcHttpBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ArcVisitor visitor) {
    visitor.visitHttpBlock(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getHttpKw() {
    return findNotNullChildByType(HTTP_KW);
  }
