...
public class ArcHttpRouteDeclarationImpl extends ArcElementImpl implements ArcHttpRouteDeclaration {

  public ArcHttpRouteDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ArcVisitor visitor) {
    visitor.visitHttpRouteDeclaration(this);
  }
  ...
  public PsiElement getHttpRouteKw() {
    return findNotNullChildByType(HTTP_ROUTE_KW);
  }
