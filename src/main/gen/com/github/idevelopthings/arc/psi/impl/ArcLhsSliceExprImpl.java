...
public class ArcLhsSliceExprImpl extends ArcExpressionImpl implements ArcLhsSliceExpr {

  public ArcLhsSliceExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArcVisitor visitor) {
    visitor.visitLhsSliceExpr(this);
  }
