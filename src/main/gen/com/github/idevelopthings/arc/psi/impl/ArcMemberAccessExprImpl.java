...
public class ArcMemberAccessExprImpl extends ArcMemberAccessExpressionMixinImpl implements ArcMemberAccessExpr {

  public ArcMemberAccessExprImpl(@NotNull ASTNode node) {
    super(node);
  }
