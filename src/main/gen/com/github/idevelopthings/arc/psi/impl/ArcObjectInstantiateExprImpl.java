...
public class ArcObjectInstantiateExprImpl extends ArcExpressionImpl implements ArcObjectInstantiateExpr {

  public ArcObjectInstantiateExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public ArcObjectInstantiateFields getObjectInstantiateFields() {
    return findNotNullChildByClass(ArcObjectInstantiateFields.class);
  }
