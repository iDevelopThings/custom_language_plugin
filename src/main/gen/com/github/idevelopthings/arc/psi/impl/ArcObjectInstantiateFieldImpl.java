...
public class ArcObjectInstantiateFieldImpl extends ASTWrapperPsiElement implements ArcObjectInstantiateField {

  public ArcObjectInstantiateFieldImpl(@NotNull ASTNode node) {
    super(node);
  }
