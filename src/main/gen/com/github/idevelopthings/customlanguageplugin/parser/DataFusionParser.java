...
package com.github.idevelopthings.customlanguageplugin.parser;

import com.intellij.lang.PsiBuilder;
import com.intellij.lang.PsiBuilder.Marker;
import static com.github.idevelopthings.customlanguageplugin.psi.DataFusionTypes.*;
import static com.github.idevelopthings.customlanguageplugin.parser.DataFusionParserUtil.*;
...
public class DataFusionParser implements PsiParser, LightPsiParser {
  ...
  /* ********************************************************** */
  // !('}' | FUNC_KW | OBJECT_KW)
  static boolean block_body_recovery_parser(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "block_body_recovery_parser")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NOT_);
    r = !block_body_recovery_parser_0(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }

  // '}' | FUNC_KW | OBJECT_KW
  private static boolean block_body_recovery_parser_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "block_body_recovery_parser_0")) return false;
    boolean r;
  ...
  /* ********************************************************** */
  // FUNC_KW func_receiver_declaration? func_id argument_declaration_list ID? block_body
  public static boolean func_declaration(PsiBuilder b, int l) {
    ...
    p = r; // pin = 5
    r = r && block_body(b, l + 1);
    exit_section_(b, l, m, r, p, DataFusionParser::func_declaration_recovery_parser);
    return r || p;
  }
  ...
  /* ********************************************************** */
  // !('.' | ';' | '}' | ID | '\n')
  static boolean memberAccessRecoveryParser(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "memberAccessRecoveryParser")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NOT_);
    r = !memberAccessRecoveryParser_0(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }

  // '.' | ';' | '}' | ID | '\n'
  private static boolean memberAccessRecoveryParser_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "memberAccessRecoveryParser_0")) return false;
    boolean r;
  ...
  public static boolean top_level_declaration(PsiBuilder b, int l) {
    ...
    exit_section_(b, l, m, r, p, DataFusionParser::top_level_declaration_recovery_parser);
    return r || p;
  }
