...
public class DataFusionArgListExprImpl extends DataFusionExpressionImpl implements DataFusionArgListExpr {

  public DataFusionArgListExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull DataFusionVisitor visitor) {
    visitor.visitArgListExpr(this);
  }
