...
public class DataFusionArgumentDeclarationImpl extends ASTWrapperPsiElement implements DataFusionArgumentDeclaration {

  public DataFusionArgumentDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
