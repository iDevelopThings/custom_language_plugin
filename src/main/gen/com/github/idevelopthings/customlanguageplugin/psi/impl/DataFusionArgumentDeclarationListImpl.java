...
public class DataFusionArgumentDeclarationListImpl extends ASTWrapperPsiElement implements DataFusionArgumentDeclarationList {

  public DataFusionArgumentDeclarationListImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<DataFusionArgumentDeclaration> getArgumentDeclarationList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, DataFusionArgumentDeclaration.class);
  }
