...
public class DataFusionArrayAccessExprImpl extends DataFusionExpressionImpl implements DataFusionArrayAccessExpr {

  public DataFusionArrayAccessExprImpl(@NotNull ASTNode node) {
    super(node);
  }
