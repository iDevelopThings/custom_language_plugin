...
public class DataFusionBlockBodyImpl extends ASTWrapperPsiElement implements DataFusionBlockBody {

  public DataFusionBlockBodyImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<DataFusionStatement> getStatementList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, DataFusionStatement.class);
  }
