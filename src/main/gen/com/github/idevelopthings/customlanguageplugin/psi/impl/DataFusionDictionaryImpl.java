...
public class DataFusionDictionaryImpl extends ASTWrapperPsiElement implements DataFusionDictionary {

  public DataFusionDictionaryImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public DataFusionDictionaryFields getDictionaryFields() {
    return findChildByClass(DataFusionDictionaryFields.class);
  }
