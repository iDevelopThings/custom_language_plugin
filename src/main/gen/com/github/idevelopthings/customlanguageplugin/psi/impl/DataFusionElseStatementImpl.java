...
public class DataFusionElseStatementImpl extends ASTWrapperPsiElement implements DataFusionElseStatement {

  public DataFusionElseStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
