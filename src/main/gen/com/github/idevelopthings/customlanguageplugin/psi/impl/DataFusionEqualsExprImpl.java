...
public class DataFusionEqualsExprImpl extends DataFusionExpressionImpl implements DataFusionEqualsExpr {

  public DataFusionEqualsExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public PsiElement getEqeq() {
    return findNotNullChildByType(EQEQ);
  }
