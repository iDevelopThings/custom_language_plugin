...
public abstract class DataFusionExpressionImpl extends ASTWrapperPsiElement implements DataFusionExpression {

  public DataFusionExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
