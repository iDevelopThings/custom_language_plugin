...
public class DataFusionGreaterThanOrEqualsExprImpl extends DataFusionExpressionImpl implements DataFusionGreaterThanOrEqualsExpr {

  public DataFusionGreaterThanOrEqualsExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull DataFusionVisitor visitor) {
    visitor.visitGreaterThanOrEqualsExpr(this);
  }
  ...
  public PsiElement getGe() {
    return findNotNullChildByType(GE);
  }
