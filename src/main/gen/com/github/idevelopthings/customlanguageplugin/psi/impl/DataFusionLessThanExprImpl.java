...
public class DataFusionLessThanExprImpl extends DataFusionExpressionImpl implements DataFusionLessThanExpr {

  public DataFusionLessThanExprImpl(@NotNull ASTNode node) {
    super(node);
  }
