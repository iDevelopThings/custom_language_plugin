...
public class DataFusionLessThanOrEqualsExprImpl extends DataFusionExpressionImpl implements DataFusionLessThanOrEqualsExpr {

  public DataFusionLessThanOrEqualsExprImpl(@NotNull ASTNode node) {
    super(node);
  }
