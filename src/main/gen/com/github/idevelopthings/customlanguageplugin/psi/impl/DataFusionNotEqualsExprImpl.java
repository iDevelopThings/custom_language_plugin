...
public class DataFusionNotEqualsExprImpl extends DataFusionExpressionImpl implements DataFusionNotEqualsExpr {

  public DataFusionNotEqualsExprImpl(@NotNull ASTNode node) {
    super(node);
  }
