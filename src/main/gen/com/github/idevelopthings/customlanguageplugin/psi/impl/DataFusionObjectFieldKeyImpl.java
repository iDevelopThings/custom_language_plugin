...
public class DataFusionObjectFieldKeyImpl extends ASTWrapperPsiElement implements DataFusionObjectFieldKey {

  public DataFusionObjectFieldKeyImpl(@NotNull ASTNode node) {
    super(node);
  }
