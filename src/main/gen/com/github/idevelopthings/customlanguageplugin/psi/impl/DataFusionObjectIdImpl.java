...
public class DataFusionObjectIdImpl extends DataFusionNamedElementImpl implements DataFusionObjectId {

  public DataFusionObjectIdImpl(@NotNull ASTNode node) {
    super(node);
  }
