...
public class DataFusionRangeExprImpl extends DataFusionExpressionImpl implements DataFusionRangeExpr {

  public DataFusionRangeExprImpl(@NotNull ASTNode node) {
    super(node);
  }
