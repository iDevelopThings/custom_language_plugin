...
public class DataFusionSliceExprImpl extends DataFusionExpressionImpl implements DataFusionSliceExpr {

  public DataFusionSliceExprImpl(@NotNull ASTNode node) {
    super(node);
  }
