...
class DataFusionFunctionReference(element: PsiElement, rangeInElement: TextRange?) : PsiReferenceBase<PsiElement>(element, rangeInElement), PsiPolyVariantReference {
